...
class MainMenuState(GameState):
    def __init__(self, game):
        ...
        target_h = int(self.screen_height * 0.28)
        ...
        # Rects for button collision detection
    ...
    def handle_event(self, event):
        """
        Handle input events: mouse clicks and key presses.
        Left click on buttons changes state; ESC issues quit event.
        """
    ...
    def draw(self, screen):
        """
        Render background, images, and buttons with hover effects.
        """
        ...
        instructions_text_rect = instructions_text.get_rect(center=self.instructions_button_rect.center)
